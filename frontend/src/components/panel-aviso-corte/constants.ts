...
const MSG_EXCEL_NO_ROWS = 'El Excel no contiene filas de datos';
const MSG_EXCEL_UNREADABLE = (detail: string) => `No se pudo leer el archivo Excel: ${detail}`;
const MSG_EXCEL_TOO_MANY_ROWS = 'El Excel excede el límite de 10.000 filas';
...
const MSG_REGEX_INVALID = (detail: string) => `Expresión regular inválida: ${detail}`;
